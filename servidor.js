...
// este archico deberia traerlo con un export o un require pero no logro que funcione!
...
// aca creo todo lo que necesito tener disponible para el get del servidor -- Tambien deberia ser un archivo aparte pero no se como importarlo

const file = './products.txt';
const container = new Contenedor(file);


// aca ya esta la creación del servidor y de los .GET
...
app.get('/', (req, res) => {
    res.send('Servidor de prueba -- Ingrese a las direcciones /productos o /productoRandom para obterner la informacio de los productos')
})
...
app.get('/productoRandom', (req, res) => {
    ...
    let productoRnadom = container.getById(randomSelector)
    let productoRnadomStr = JSON.stringify(productoRnadom)
    res.send(`El producto aleatorio que seleccionamos para vos es: ${productoRnadomStr} `)
})